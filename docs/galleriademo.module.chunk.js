...
var Galleria = (function () {
    function Galleria(el, domHandler) {
        ...
        this.onImageClicked = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */]();
        this.stripLeft = 0;
    }
